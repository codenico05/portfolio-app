    ...
    <div className={styles.container}>
      <motion.div variants={textVariants} className={styles['text-wrapper']}>
        ...
        <motion.p
          ...
          whileInView={{ x: 0, opacity: 1, transition: { duration: 0.5 } }}
        >
          Hi, I am Code Nico, a Web & Mobile Developer dedicated to crafting
          user-friendly applications. I also enjoy creating engaging content
          through videos and blog posts about programming. Lets explore the
